                              ...
                              <tbody>
                                  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                                          ...
                                          <td>
                                              ...
                                              <a id-data="<?php echo ($vol["id"]); ?>" id-title="<?php echo ($vol["title"]); ?>" id-rec="<?php echo ($vol["username"]); ?>" id-read="<?php echo ($vol["isread"]); ?>" class="fa fa-check b_white look btn btn-success ">查看</a>
  ...
  <script>
    ...
    $('.look').on('click',function(){
            ...
            content: ['//fly.layui.com/', 'no'], //iframe的url，no代表不显示滚动条
                ...
                layer.open({
                    ...
                    //只有是收件人才可以修改邮件的已读状态，发件人修改不合理
                        ...
                        if(eread== 0){
                            window.location.href='/index.php/Admin/Email/recIsread/id/'+id;
                        }
      ...
      $('.pull_out').on('click',function(){
          window.location.href = '/index.php/Admin/Email/getExcel';
