    ...
    <div class="row">
        <div class="panel panel-info col-md-10">
            <div class="panel-heading" style="text-align: center">
                <h3 class="panel-title btn btn-info disabled">添 加 小 说 章 节 及 内  容</h3>
            </div>
            <div class="panel-body">
                <form action="/index.php/Admin/Story/addItem" method="post">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control s_name" name="sort" placeholder="">
                    </div>
                    <div class="form-group ">
