...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/job/js/bootstrap-datepicker/css/datepicker.css" />
    <link rel="stylesheet" type="text/css" href="/Public/job/js/bootstrap-daterangepicker/daterangepicker.css" />
  ...
  <section id="container" >
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="/Public/job/img/ui-zac.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="/Public/job/img/ui-divya.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="/Public/job/img/ui-danro.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="/Public/job/img/ui-sherman.jpg"></span>
                                    <span class="subject">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.html"><img src="/Public/job/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
    ...
    <script src="/Public/job/js/jquery-ui-1.9.2.custom.min.js"></script>

	<!--custom switch-->
	<script src="/Public/job/js/bootstrap-switch.js"></script>
	
	<!--custom tagsinput-->
	<script src="/Public/job/js/jquery.tagsinput.js"></script>
	
	<!--custom checkbox & radio-->
	
	<script type="text/javascript" src="/Public/job/js/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="/Public/job/js/bootstrap-daterangepicker/date.js"></script>
	<script type="text/javascript" src="/Public/job/js/bootstrap-daterangepicker/daterangepicker.js"></script>
	
	<script type="text/javascript" src="/Public/job/js/bootstrap-inputmask/bootstrap-inputmask.min.js"></script>
	
	
	<script src="/Public/job/js/form-component.js"></script>    
